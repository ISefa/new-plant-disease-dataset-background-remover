This project is a background removal code that tries to remove the grey backgrounds on the New Plant Disease Dataset from kaggle.com without removing the diseases.
